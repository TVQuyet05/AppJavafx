...
public class CommentBook extends  Book{
    ...
    public CommentBook(String id, String title, String author,
                       String genre, String date, String description,
                       int quantity, String image, String comment,
                       Integer judge) {
    ...
    public CommentBook(String id, String title,
                       String author, String comment,
                       int judge, String studentNumber,
                       String studentName) {
    ...
    public CommentBook(String id, String title,
                       String author, String comment, int judge) {
        super(id, title, author);
        this.comment =comment;
        this.judge = judge;
    }
